...
export const page: Page = {
  ...
  section: {
    items: [
      ...
      },
      {
        name: "how",
        title: "《极光之歌》",
        description: "《极光之歌》是一部科幻小说。故事围绕两位主角：中国气候物理学家陈贤和芬兰极光追逐者托沃的“追光之旅”缓缓展开。寒冷的北欧极地，氤氲的极光中似乎正传递着某种神秘的“极光之声”；深邃夜空，特殊的电波信号似乎蕴藏着某种难以名状的信息和规律。分别与重逢的命运，信仰与追求的冲突；古生物学与盘古大陆的谜题，历史古河与科学哲理的纠葛；当种种命题碰撞交汇，时间与生命的交响曲再次奏响，人类与宇宙的交缘之钟再次长鸣...... 《极光之歌》融合科学研究、宇宙奥秘与人性执着于一体，反映了人类面对未知挑战时的坚韧勇毅，在科学探索和追求真相中的不懈执着；更深刻探讨了人类对未知世界的无尽好奇与追求，以及在浩瀚宇宙中寻找生命意义的永恒主题。",
        image: {
          src: "/imgs/section10.png",
        },
        image_position: "right",
        text_align: "center",
      },
  ...
  testimonial: {
    ...
    items: [
      ...
      },
      {
        ...
        video: {
          src: "/videos/zjwl-1208-1-mobile.mp4",
          poster: "/imgs/zjwl-1208-1-mobile.png",
          title: "The Birth of FizzDragon",
        },
      },
      {
      ...
      },
      {
        ...
        video: {
          ...
          poster: "/imgs/vietnam.png",
          title: "The Birth of FizzDragon",
        },
      },
      {
        title: "《新加坡“新”IP宣传片》",
        description: "新加坡的“新”IP宣传片充满了现代感与未来感，展示了一个充满活力的全球化都市。画面中，高耸入云的摩天大楼与繁华的城市景观交相辉映，影片穿插着充满创意的镜头，展现新加坡在智慧城市、绿色科技和多元文化方面的领先地位。来自世界各地的创新者、企业家和艺术家们齐聚在这座城市，描绘出一个以开放、创新和可持续发展为核心的未来之都，吸引全球的目光。",
        video: {
          src: "/videos/singapore.mp4",
          poster: "/imgs/singapore.png",
          title: "The Birth of FizzDragon",
        },
      },
      {
        title: "《按摩椅广告宣传片》",
        description: "无论是长途飞行还是居家休息，按摩椅通过温和的按摩模式和多种调节选项，帮助缓解肌肉疲劳，减轻压力，让您在云端也能感受到家的温暖与舒适。配合静谧的机舱环境，您将会体验到前所未有的惬意和宁静。按摩椅伴您翱翔天际，尽享放松时刻！",
        video: {
          src: "/videos/chair.mp4",
          poster: "/imgs/chair.png",
          title: "The Birth of FizzDragon",
        },
      },
      {
  ...
  faq: {
    ...
    items: [
      ...
      {
        title: "沸腾宇宙AIGC电影实验室 | 用拼图的方式拍电影？全网征集10000张照片，挑战想象力叙事极限",
        description: "",
      ...
      {
        title: "签约专栏｜当地球沸腾！“娘子关杯”一等奖得主暨科幻小说《重生之愿》作者王云轩与FizzDragon签约",
        description: "",
